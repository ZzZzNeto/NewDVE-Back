...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://localhost/newdve_back",
    ),
}
...
MIGRATION_MODULES = {"sites": "newdve_back.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "newdve_back.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Jose neto and Breno Soares""", "jose-neto-and-breno-soares@dve.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "newdve_back.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "newdve_back.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "newdve_back.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "newdve_back.users.forms.UserSocialSignupForm"}
